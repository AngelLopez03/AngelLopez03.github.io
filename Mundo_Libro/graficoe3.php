...
<html>
    ...
    <body id="body">
       ...
       <div class="btn_graficos col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="select col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="graficoe3.php">¿Que prefieres?</a></div>
        ...
        <h1 class="titulog">GRÁFICO DE ¿Que prefieres?</h1>
...
pieSeries.dataFields.value = "cant_prefieres1";
pieSeries.dataFields.category = "que_prefieres1";
