        	...
        	<section class="fila" id="seccion2_book">
        		<div class="cabecera col-lg-10 col-md-10 col-sm-10 col-xs-10">
	        		<div class="container_img_book col-lg-4 col-md-3 col-sm-3 col-xs-4">
                        <img src="../bdImg/centro.jpg" width="200" height="280"
                         alt="La historia de un beso">
	        		...
	        		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
	        			...
	        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	        				<p>
	        					 Axel reside en una vieja casa situada en la Königstrasse, en Hamburgo, junto a su tío Otto Lidenbrock, un prestigioso profesor de mineralogía en el "museo de Hamburgo" a quien describe como un hombre temido por su fuerte carácter pero muy original; su ahijada Gräuben y su sirvienta, Marta.
	        				</p>
	        			</div>
	        			...
	        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	        				...
	        				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">Julio Verne</div>
	        				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">1864</div>
        	...
        	<section class="fila" id="seccion3_book">
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <div class="articulo col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h1><b>Viaje al centro de la tierra </b></h1>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <p>
                                Un domingo de mayo de 1863, el profesor volvió a su casa. Era muy impaciente, venía con hambre del viaje.
                                El entró a la casa con pasos fuertes haciendo crujir el piso.
                                El profesor daba clases de mineralogía. Pero era UN VERDADERO SABIO experto con sus herramientas de minería. El era un conservador del museo de “Sturne”.
                                <br>
                                <br>
                                Por ser profesor era bastante rico Axel era su ayudante de sus experimentos, llevaba en su sangre las ciencias geológicas porque jamás se aburría.
                            </p>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <p>
                                    Axel conocía muy bien todos los chirimbolos de la ciencia mineralógica. Pasaba largas horas sacando el polvo del gabinete que era un verdadero museo. El profesor Lidenbrock tenía como su preferido a un libro …ver más…
                                    <br>
                                    <br>
                                    Scartis era el pico de una montaña cuya sombra marcaba la entrada al cráter en cuestión. El sobrino pensaba que aunque el documento fuera autentico era imposible que el sabio Saknussem hubiera hecho el viaje al centro de la Tierra, porque no hubiera podido resistir el calor interno. El tío aseguro que nadie podía saberlo porque no existía una experiencia y todas las teorías podían ser reemplazadas por otras. La única forma de comprobar las hipótesis era haciendo el viaje al centro de la Tierra.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="container-aside col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <?php                            
                        $query = "SELECT * FROM libros limit 3,2 ";
