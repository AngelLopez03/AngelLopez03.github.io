        	...
        	<section class="fila" id="seccion2_book">
        		<div class="cabecera col-lg-10 col-md-10 col-sm-10 col-xs-10">
	        		<div class="container_img_book col-lg-4 col-md-3 col-sm-3 col-xs-4">
                        <img src="../bdImg/crimen.jpg" width="200" height="280"
                         alt="Calix">
	        		...
	        		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
	        			...
	        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	        				<p>
	        					El mayor atractivo del Dupayne, un museo privado dedicado a los años de entreguerras (1919-1939), es una inquietante Sala del Crimen donde se estudian los casos más sonados de la epoca.

Pero Neville, el menor de los hermanos Dupayne, considera que la institución debe cerrar sus puertas. La incertidumbre sobre la continuidad del museo genera una insoportable tensión, que se quebrará cuando se descubra el cuerpo calcinado de Neville.
	        				</p>
	        			</div>
	        			...
	        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	        				...
	        				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">P. D. James</div>
        	...
        	<section class="fila" id="seccion3_book">
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <div class="articulo col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <p>
                            Una tensión insoportable se cierne sobre la gente vinculada al Museo Dupayne, un institución dedicada a los años de entreguerras. Neville Dupayne, el menor de los tres hermanos dueños del museo, no está de acuerdo en firmar la renovación del contrato del Dupayne: para él, el museo debe cerrar. A pesar de las insistencias de sus hermanos y del personal del edificio, se muestra inamovible.
<br>
<br>
                            Cuando queda bien en claro que todos los personajes tienen motivos más que suficientes para matar a Neville Dupayne, se encuentra su cuerpo calcinado dentro de un automóvil en llamas.
<br>
<br>
                            Dalgliesh, junto con su equipo policial (conformado por la Kate Miskin, Piers Tarrant y Benton-Smith), deberán hallar la solución de un enigma que se complica con nuevas muertes. Y lo más intrigante es que cada una de esas muertes están firmemente relacionadas con los sucesos ilustrados en la magistrar Sala del Crimen, atracción principal para los visitantes del Dupayne. Esta Sala del Crimen muestra los casos policiales de los años de entreguerras.
                            </p>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h2><b></b></h2>
