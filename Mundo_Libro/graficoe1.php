...
<html>
    ...
    <body id="body">
       ...
       <div class="btn_graficos col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="select col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="graficoe1.php">¿Te gusta leer?</a></div>
        ...
        <h1 class="titulog">GRÁFICO DE ¿Te gusta leer?</h1>
...
pieSeries.dataFields.value = "cant_leer";
pieSeries.dataFields.category = "g_leer";
