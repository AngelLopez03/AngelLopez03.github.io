...
<html>
    ...
    <body id="body">
       ...
       <div class="btn_graficos col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="select col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="graficoe7.php">¿Te deja enseñanza la lectura?</a></div>
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="Graficos.php">Libros</a></div>
       </div>
        

        <h1 class="titulog">GRÁFICO DE ¿Te deja enseñanza la lectura?</h1>
...
pieSeries.dataFields.value = "cant_enseñanza";
pieSeries.dataFields.category = "enseñanza";
