...
<html>
    ...
    <body id="body">
       ...
       <div class="btn_graficos col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="select col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="graficoe4.php">¿Es más culta?</a></div>
        ...
        <h1 class="titulog">GRÁFICO DE ¿Es más culta?</h1>
...
pieSeries.dataFields.value = "cant_culta";
pieSeries.dataFields.category = "gente_culta";
