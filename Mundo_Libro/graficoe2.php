...
<html>
    ...
    <body id="body">
      ...
      <div class="btn_graficos col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="select col-lg-2 col-md-2 col-sm-12 col-xs-12"><a href="graficoe2.php">Género</a></div>
        ...
        <h1 class="titulog">GRÁFICO DE Género</h1>
...
pieSeries.dataFields.value = "cant_generos";
pieSeries.dataFields.category = "generos";
