...
<html>
    ...
    <body id="body">
       ...
       <div class="btn_graficos col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="select col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="Graficos.php">Ranking</a></div>
           <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="graficopag.php">Número de páginas</a></div>
           <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="masVendido.php">Más vendido</a></div>
           <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="graficoEncuesta.php">Encuesta</a></div>
       </div>
        

        <h1 class="titulog">GRÁFICO DE RANKING</h1>
...
<script>
    ...
    const mostrar = (articulos)=> {
     ...
     //Add and configure Series
        ...
        axisBreak.startValue = 7;
        axisBreak.endValue = 10.5;
