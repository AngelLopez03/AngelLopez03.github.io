		...
		<header class="fila">
                ...
                <div class="position1 col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <?php
                            if (isset($_SESSION['usuario'])) {
                    ?>
                                <div class="cerrar col-lg-6 col-md-6 col-sm-6 col-xs-6"><a href="backend/cerrar_sesion.php">Cerrar Sesión</a></div>
                                <i class="fas fa-user icon_user col-lg-6 col-md-6 col-sm-6 col-xs-6"></i>                               
                    <?php   
                            }else{

                    ?>
                                <div id="icono1" class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="login.php"><center><i class="fas fa-user"></i></center></a></div>
                    <?php
                            }
                    ?>
                </div>
        ...
        <section class="fila" id="seccion2">
        	<div class="libros-container-cover col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="container-info-cover col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <hr>
                    <h1 class="col-lg-12 col-md-12 col-sm-12 col-xs-12">MUNDO LIBRO</h1>
                </div>
            </div>
        </section>
        <section class="fila" id="seccion3">
        	<div class="container_3 col-lg-10 col-md-10 col-sm-10 col-xs-10">
        		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        			<div class="container-catalogo col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                    <div class="titulo col-lg-12 col-md-12 col-sm-12 col-xs-12">La espléndida biblioteca de la Vocacional</div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">La colección de la biblioteca contiene más de 1 mil de artículos.</div>
	                    <div class="redondeado2 col-lg-6 col-md-6 col-sm-6 col-xs-12">El catálogo de la biblioteca</div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i class="far fa-play-circle col-lg-1 col-md-1 col-sm-1 col-xs-0"></i><p class="col-lg-11 col-md-11 col-sm-11 col-xs-12">Colecciones internacionales</p></div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i class="far fa-play-circle col-lg-1 col-md-1 col-sm-1 col-xs-0"></i><p class="col-lg-11 col-md-11 col-sm-11 col-xs-12">Libros electrónicos</p></div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i class="far fa-play-circle col-lg-1 col-md-1 col-sm-1 col-xs-0"></i><p class="col-lg-11 col-md-11 col-sm-11 col-xs-12">Manuscritos</p></div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i class="far fa-play-circle col-lg-1 col-md-1 col-sm-1 col-xs-0"></i><p class="col-lg-11 col-md-11 col-sm-11 col-xs-12">Información científica y técnica</p></div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i class="far fa-play-circle col-lg-1 col-md-1 col-sm-1 col-xs-0"></i><p class="col-lg-11 col-md-11 col-sm-11 col-xs-12">Libros de historietas</p></div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i class="far fa-play-circle col-lg-1 col-md-1 col-sm-1 col-xs-0"></i><p class="col-lg-11 col-md-11 col-sm-11 col-xs-12">Cartografía</p></div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i class="far fa-play-circle col-lg-1 col-md-1 col-sm-1 col-xs-0"></i><p class="col-lg-11 col-md-11 col-sm-11 col-xs-12">Revistas</p></div>
	                    <div class="ver_mas col-lg-3 col-md-3 col-sm-3 col-xs-4"><a href="libros.php">Ver Más</a></div>
	                </div>
	                <div class="extras col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                	<div class="book col-lg-5 col-md-5 col-sm-5 col-xs-12">
	                        <i class="fas fa-book"></i>
	                        <p>Biblioteca de derecho</p>
	                        <div class="ver_mas col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="libros.php">Leer más</a></div>
	                    </div>
	                    <div class="book col-lg-5 col-md-5 col-sm-5 col-xs-12">
	                    	<i class="fas fa-book"></i>
	                    	<p>Materiales asiáticos</p>
	                    	<div class="ver_mas col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="libros.php">Leer más</a></div>
	                    </div>
	                </div>
        		</div>
        		<div class="container_img col-lg-6 col-md-6 col-sm-6 col-xs-12">
        			<img class="col-lg-12 col-md-12 col-sm-12 col-xs-12" src="img/FRS_Racool_1020_0001-32.jpg" alt="Mundo Libros">
        		</div>
        	</div>
        </section>
	</div>
