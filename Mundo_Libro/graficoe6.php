...
<html>
    ...
    <body id="body">
      ...
      <div class="btn_graficos col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class=" col-lg-3 col-md-3 col-sm-12 col-xs-12"><a href="graficoEncuesta.php">Edad</a></div>
           ...
           <div class="select col-lg-4 col-md-4 col-sm-12 col-xs-12"><a href="graficoe6.php">¿Cuantos libros tenes en casa?</a></div>
        ...
        <h1 class="titulog">GRÁFICO DE ¿Cuantos libros tienes en tú casa?</h1>
...
pieSeries.dataFields.value = "cant_libros_casa";
pieSeries.dataFields.category = "libros_en_casa";
